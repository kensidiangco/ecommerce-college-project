		...
		<>
			...
			<div className="flex justify-center py-4 md:py-10">
				<div className="flex flex-col md:flex-row justify-center gap-2 md:gap-5 xl:gap-10">
					<div className="grid gap-4 md:gap-px md:dark:bg-dark-card md:bg-white md:shadow-md xl:shadow-xl rounded-md md:rounded-xl p-2 md:p-4">
						<p className="text-xl md:text-2xl font-semibold text-gray-700 dark:text-gray-50 transition delay-100">Your cart</p>
						<div className="px-2 py-4 md:p-5 flex flex-col md:flex-row items-center md:gap-4 md:bg-none dark:bg-dark-card bg-white rounded-xl shadow-md md:shadow-none">
							...
							<div>
								...
								<div className="flex justify-center mt-2 md:float-right">
									<input type="submit" value="Remove" className="text-sm py-1 px-3 cursor-pointer rounded-lg text-gray-700 dark:text-gray-50 dark:bg-dark-card transition delay-100" />
								</div>
							</div>
						</div>
						...
						<div className="py-5 px-3 md:p-3 flex flex-col md:flex-row items-center md:bg-none dark:bg-dark-card bg-white rounded-xl shadow-md md:shadow-none justify-around space-y-4 md:space-y-0">
							<p className="text-2xl text-blue-700 dark:text-blue-400 transition delay-100">Total: ₱2,798</p>
							<div className="p-3 bg-blue-500 text-gray-50 dark:bg-dark-button dark:hover:bg-button-hover rounded-md hover:bg-blue-400 transition delay-100 cursor-pointer">
								<Link href="/dailylife/checkout">Proceed to checkout</Link>
							</div>
						</div>
					</div>
					<div className="mt-4 md:mt-px dark:bg-dark-card shadow-md xl:shadow-xl bg-white rounded-xl p-2 md:p-4">
						...
						<div className="flex justify-center">
							<input type="submit" value="See more..." className="px-3 py-2 text-blue-800 dark:text-blue-500 dark:bg-dark-card bg-white cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-900 transition delay-100 rounded-md" />
						</div>
					</div>
				</div>
			</div>
