...
export default function Cart() {
	...
	return(
		<>
			...
			<div className={`container mx-auto flex gap-4 md:gap-4 justify-center md:px-6 py-4 md:py-6 md:py-10 px-8 md:px-2 ${items.length < 1 ? "items-center flex-col" : "flex-col md:flex-row"}`}>
				<div className="">
					{items.length < 1 && <p className="text-xl grid gap-4 gap-px dark:bg-dark-card bg-gray-50 shadow-md  rounded-md p-10">Your cart is empty.</p>}
					{items.length > 0 && 
