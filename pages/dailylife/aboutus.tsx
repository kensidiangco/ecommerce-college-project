        ...
        <>  
            ...
            <div className="container">
                ...
                <div className="container p-5 md:mx-10">
                    ...
                    <div className="flex flex-col md:flex-row flex-wrap gap-x-10 gap-y-10 justify-center place-items-center place-items-center m-5">
                    ...
                    <div className="flex flex-col md:flex-row flex-wrap gap-x-10 gap-y-10 justify-center place-items-center place-items-center m-5 gap-5">
                        <div className="bg-gray-200 text-gray-900 dark:text-gray-50 dark:bg-gray-800 rounded-2xl flex flex-col gap-4 md:rounded-2xl filter shadow-lg md:w-80">  
